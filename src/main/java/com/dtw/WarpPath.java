...
public class WarpPath
{
   ...
   public ArrayList<Integer> getTsIindexes() {
      return (ArrayList<Integer>) tsIindexes;
   }

   public ArrayList<Integer> getTsJindexes() {
      return (ArrayList<Integer>)tsJindexes;
   }
   ...
   {
      if ( (obj instanceof WarpPath) )  // trivial false AddAbnormal
      {
